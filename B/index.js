...
const BotName = 'adryanbot';
const aktif = '08:00 - 22:00';
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:adryan\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=+5515998609727:+55 1599860-9727\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD ADRYAN BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de adryan. Registre-se para fazer amizade com o bot adryan por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar adryan|14\n\n──「 Adryan BOT 」──`,
			...
			const ownerNumber = ["+5515998609727@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"+5515998609727@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["+5515998609727@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["+5515998609727@s.whatsapp.net"]//ubah nomor lo
			const premium = ["+5515998609727@s.whatsapp.net","5515998609727@s.whatsapp.net","5515998609727@s.whatsapp.net","5515998609727@s.whatsapp.net","5515998609727@s.whatsapp.net","5515998609727@s.whatsapp.net","5515998609727@s.whatsapp.net","5515998609727@s.whatsapp.net","5515998609727@s.whatsapp.net"]
           ...
           case 'playmp3':
            ...
            case 'smule':
                ...
                case 'pinterest':
					...
					break
                case 'adryanjokes':
				 data = fs.readFileSync('./src/adryanjokes.js');
                 jsonData = JSON.parse(data);
                 randIndex = Math.floor(Math.random() * jsonData.length);
                 randKey = jsonData[randIndex];
                hasil = await getBuffer(randKey.result)
		...
		case 'happymod':
			...
			break
				...
				case 'adryan':
					...
					client.sendMessage(from, nye, image, { caption: 'adryan!!', quoted: mek })
					await limitAdd(sender)
					break 
				case 'nsfwboquete':
...
// recursos anime, random @nabuto domina vida
          ...
          reply('Espere..')
                                       ...
                                       if (args[0].startsWith('5515998609727')) return reply('Falha ao ligar para o número do bot')
                                       if (args[0].startsWith('5515998609727')) return reply('Falha ao ligar para o número do proprietário')
			    ...
			    case 'dono':
                    ...
                    client.sendMessage(from, 'Meu dono é esse gasoso aí tal de "adryan" e "nabuto"🙄, chama ele aí ele diz que é "Shitpost"',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT ADRYAN ✨* 」\n*│+ wa.me/+5515998609727*╰──────*「 *ADRYAN* 」*────*\n\n*_SE QUER SER ADMIN DO BOT ADRYAN_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/+5515998609727*╰──────*「 * ADRYAM* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO ADRYAN BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do nabuto e adryan:*\n\n https://youtube.com/channel/UCZEtf9AlsC2zsJQwrfW-44w'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
